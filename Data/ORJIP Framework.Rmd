...
```
```{r EnvCovViz, message=FALSE, warning=FALSE,  cache=TRUE,echo=FALSE,error=FALSE, fig.height=3, fig.width=8,  fig.align='center',fig.cap="\\label{Landscape} The coastline definition and the associated marine covariate"}
...
```{r DerCovCal, message=FALSE, warning=FALSE,  cache=TRUE,echo=FALSE,error=FALSE}
distCol.Plot<-bath.Plot

```

```{r DerCovViz, message=FALSE, warning=FALSE,  cache=TRUE,echo=FALSE,error=FALSE, fig.height=3, fig.width=8,  fig.align='center',fig.cap="\\label{Landscape} The coastline definition and the associated marine covariate"}

multiplot(distCol.Plot,distCol.Plot,distCol.Plot, layout=matrix(c(1,2,3), 1,3))
```
